...
export class SetSubscriptiomPlanComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const subscrptsubscriptionPricing = this.authService.getUserData().subscriptionPricing;

    this.subscriptionForm.setValue({
      amount1: subscrptsubscriptionPricing['1_month'],
      amount3: subscrptsubscriptionPricing['3_months'],
      amount6: subscrptsubscriptionPricing['6_months'],
    });
    console.log('subscription pricing : ', subscrptsubscriptionPricing);
  }
